...
This policy is borrowed from [Fedify's AI usage policy][1], which is inspired
by [Ghostty's AI policy][2].

The Sacho project has the following rules for AI usage:
...
These rules apply only to outside contributions to Sacho.  Maintainers are
...
Please remember that Sacho is maintained by humans.
...
Sacho is written with plenty of AI assistance, and many maintainers embrace
